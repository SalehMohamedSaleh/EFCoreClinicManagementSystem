        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Doctor_Name_MinLength", "LEN(Name) >= 3");
                    table.CheckConstraint("CK_Doctor_Specialization_MinLength", "LEN(Specialization)>=3");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Ck_Patient_Name_Length", "LEN(Name)>3");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dosage = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
